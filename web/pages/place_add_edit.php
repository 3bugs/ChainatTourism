                    ...
                    <div class="col-xs-12">
                        ...
                        if ($placeType !== 'otop') {
                            for ($i = 1; $i <= 3; $i++) {
                                ...
                                <div class="box box-warning">
                                    <div class="box-header with-border">
                                        <h3 class="box-title">รูปภาพ Cover หน้ารายละเอียด <?= "รูปที่ {$i}"; ?>
                                            <!--<small></small>-->
                                        </h3>
                                    ...
                                    <div class="box-body pad" style="background_: #f8f8f8">
                                        ...
                                        if (!empty($place)) {
                                            ...
                                            <div class="nav-tabs-custom">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="cover_image_tab_1<?= $i; ?>">
                                                        ...
                                                        <a href="<?= (DIR_IMAGES . ($place['image_cover' . ($i === 1 ? '' : "_$i")] ? $place['image_cover' . ($i === 1 ? '' : "_$i")] : 'ic_no_image_2.png')); ?>"
                                                           data-lightbox="coverImage" data-title="<?= $place['title']; ?>">
                                                            <img src="<?= (DIR_IMAGES . ($place['image_cover' . ($i === 1 ? '' : "_$i")] ? $place['image_cover' . ($i === 1 ? '' : "_$i")] : 'ic_no_image_2.png')); ?>"
                                                                 width="<?= $place['image_cover' . ($i === 1 ? '' : "_$i")] ? '300px' : '100px'; ?>">
                                                        </a>
                                                        <?php
                                                        if ($i !== 1 && $place['image_cover' . ("_$i")]) {
                                                            ?>
                                                            <button type="button" class="btn btn-danger"
                                                                    style="margin-left: 6px; margin-right: 6px"
                                                                    onClick="onClickDeleteCoverImage(this, <?= $i; ?>)">
                                                    ...
                                                    <div class="tab-pane" id="cover_image_tab_2<?= $i; ?>" style="padding: 0px">
                                                        ...
                                                        <input id="cover-image-file-upload<?= $i; ?>" name="coverImageFile<?= $i; ?>"
                                                               type="file" accept="image/*"
                                                               style="width: 500px; margin-top: 10px; border: 2px dotted #ccc; padding: 10px 10px 50px 10px"/>
                                            ...
                                            <input id="cover-image-file-upload<?= $i; ?>" name="coverImageFile<?= $i; ?>" <?= $i === 1 ? 'required' : '' ?>
                                                   type="file" accept="image/*"
                                                   style="width: 500px; margin-top: 10px; margin-bottom: 10px; border: 2px dotted #ccc; padding: 10px 10px 50px 10px"
                                                   oninvalid="this.setCustomValidity('เลือกรูปภาพ Cover')"
                                                   oninput="this.setCustomValidity('')"/>
                                            <div id="cover-image-upload-preview<?= $i; ?>"
                                                 style="background: #efffd1; padding: 10px;"></div>
                                            <?php
...
<script>
    ...
    $(function () {
        ...
        $('#cover-image-upload-preview2').hide();
        $('#cover-image-upload-preview3').hide();
        ...
        $('#cover-image-file-upload2').on('change', function () {
            coverImagePreview(this, 'div#cover-image-upload-preview2');
        });
        $('#cover-image-file-upload3').on('change', function () {
            coverImagePreview(this, 'div#cover-image-upload-preview3');
        });
    });
    ...
    function onClickDeleteCoverImage(element, imageNumber) {
        BootstrapDialog.show({
            title: 'ลบภาพ Cover',
            message: `การลบจะมีผลกับฐานข้อมูลทันที!\n\nยืนยันลบภาพ Cover นี้?`,
            buttons: [{
                label: 'ลบ',
                action: function (self) {
                    doDeleteCoverImage(<?= isset($placeId) ? $placeId : 0; ?>, imageNumber);
                    self.close();
                },
                cssClass: 'btn-primary'
            }, {
    ...
    function doDeleteCoverImage(placeId, imageNumber) {
        $.post(
            '../api/api.php/delete_place_cover_image',
            {
                placeId: placeId,
